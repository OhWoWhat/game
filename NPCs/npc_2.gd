...
var normal_dialogue := [
	...
	"Have you watched the news? I Hope it won't happen",
	"Have you seen the bakery? Their muffins are legendary!",
	"Good morning!",
	"How's it going?",
	"The mayor says everything's fine, but I don't buy it."
]
